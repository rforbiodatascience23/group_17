...
# DEG for Lum A, LumB and Basal Like has been identified using the self-made function linear_model_deg

#Luminal A
Luminal_A <- linear_model_deg(full_data,"DGEA_Luminal_A")

#Luminal B
Luminal_B <- linear_model_deg(full_data,"DGEA_Luminal_B")

#Basal like
Basal_like <- linear_model_deg(full_data,"DGEA_Basal_like")
