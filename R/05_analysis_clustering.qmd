...
Here, the hierachial clustering is done and plotted as a dendrogram using the `hc_dendro_plot` fundtion from the `99_proj_func.R` file. The function first takes the count matrix and calculates the hierarchical clustering. Hereafter, it plots the results as a dendrogram while colouring for pam50-subtypes
