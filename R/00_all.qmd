...
###### FILE 07
quarto::quarto_render("07_analysis_diff_exp_DONE.qmd",
                      output_format = "html",
                      execute = T)
...
###### FILE 08
quarto::quarto_render("08_analysis_volcano_plots_DONE.qmd",
                      output_format = "html",
                      execute = T)
file.rename(from = "08_analysis_volcano_plots_DONE.html",
            to = "../results/08_analysis_volcano_plots_DONE.html")
file.rename(from = "08_analysis_volcano_plots_DONE_files/",
            to = "../results/08_analysis_volcano_plots_DONE_files")

###### FILE 09
quarto::quarto_render("09_analysis_heatmaps_diff_exp_DONE.qmd",
                      output_format = "html",
                      execute = T)
file.rename(from = "09_analysis_heatmaps_diff_exp_DONE.html",
            to = "../results/09_analysis_heatmaps_diff_exp_DONE.html")
file.rename(from = "09_analysis_heatmaps_diff_exp_DONE_files/",
            to = "../results/09_analysis_heatmaps_diff_exp_DONE_files")


###### FILE 10
quarto::quarto_render("10_analysis_dendro_signif_proteins_DONE.qmd",
                      output_format = "html",
                      execute = T)
file.rename(from = "10_analysis_dendro_signif_proteins_DONE.html",
            to = "../results/10_analysis_dendro_signif_proteins_DONE.html")
file.rename(from = "10_analysis_dendro_signif_proteins_DONE_files/",
            to = "../results/10_analysis_dendro_signif_proteins_DONE_files")


###### FILE 11
quarto::quarto_render("11_analysis_kmeans_DONE.qmd",
                      output_format = "html",
                      execute = T)
file.rename(from = "11_analysis_kmeans_DONE.html",
            to = "../results/11_analysis_kmeans_DONE.html")
file.rename(from = "11_analysis_kmeans_DONE_files/",
            to = "../results/11_analysis_kmeans_DONE_files")
