...
clinical_data <- read_delim("../data/clinical_load.csv",delim = ",") 
PAM50_file <- read_delim("../data/PAM50_load.csv", delim = ",") 
```
...
#quarto::quarto_render("02_clean_DONE.qmd",output_format = "html",execute = T)
