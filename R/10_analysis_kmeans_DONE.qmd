...
PCA_kmeans <- pca_aug |>
  ...
  ggplot(aes(x = .fittedPC1, y = .fittedPC2, color = factor(k_means_clusters), fill = factor(k_means_clusters))) +
  geom_vline(xintercept = 0) +
  geom_hline(yintercept = 0) +
  geom_point(shape = 21, size = 6, alpha = 0.7, aes(shape = pam50)) +
  labs(
    title = "PCA categorized through clusters",
  ...
  theme_bw() + 
  stat_ellipse(aes(fill = pam50, color = pam50), 
               type = "t", 
               geom = "polygon", 
               alpha = 0.1) 
